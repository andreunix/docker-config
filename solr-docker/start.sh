...
if bin/solr zk ls /configs/$folder_name -z zoo1:2181,zoo2:2181,zoo3:2181 | grep -q $folder_name; then
    ...
    bin/solr zk upconfig -n $folder_name -d /opt/solr/server/solr/configsets/myconfig -z zoo1:2181,zoo2:2181,zoo3:2181
fi
